...
export class Scroll extends React.Component {
  ...
  initThree = () => {
    ...
    const mesh1 = new THREE.Mesh(new THREE.TorusBufferGeometry(.6, .3, 12, 40), material);
    const mesh2 = new THREE.Mesh(new THREE.OctahedronBufferGeometry(1), material);
    const mesh3 = new THREE.Mesh(new THREE.TorusKnotBufferGeometry(.5, .20, 70, 12), material);
    mesh1.position.x = 2;
    mesh2.position.x = -2;
    mesh3.position.x = 2;
  ...
  render () {
    return (
      <div id="scroll">
      <div className='head'>胡玉炜的个人网站</div>
